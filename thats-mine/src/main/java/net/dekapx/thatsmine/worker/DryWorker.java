...
public class DryWorker extends Thread {
    private static final Logger LOGGER = LoggerFactory.getLogger(DryWorker.class);

    private BlockingQueue<Component> conveyerBelt;

    public DryWorker(final BlockingQueue<Component> conveyerBelt, final String threadName){
